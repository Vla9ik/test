(() => {
    ...
    function formSubmit() {
        ...
        function formSent(form, responseResult = ``) {
            const nameValue = form.querySelector('input[name="form[]"][id="name"]').value;
            const emailValue = form.querySelector('input[name="form[]"][id="email"]').value;
            const messageValue = form.querySelector('textarea[name="form[]"][id="message"]').value;
    ...
    function initSliders() {
        ...
        if (document.querySelector(".overview__slider")) new swiper_core_Swiper(".overview__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    const googlePlayLinks = document.querySelectorAll(".link");
